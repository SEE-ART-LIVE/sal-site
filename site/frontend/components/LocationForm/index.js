...
class LocationForm extends React.Component {
    ...
    async onSubmit(e) {
        ...
        const postNewAddress = await axios.post("http://localhost:1337/locations/", {
            Name: data.name,
        ...
        const postUserRelation = await axios.put(`http://localhost:1337/users/${userId}`, {
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <Row>
                    <Col sm="12" md={{ size: 5, offset: 3 }}></Col>
                    <Col sm="12" md={{ size: 5, offset: 3 }}>
                        <div className="header"><h3>Location</h3></div>
                    </Col>
                    <Col sm="12" md={{ size: 5, offset: 3 }}>
                                ...
                                <FormGroup>
                                    ...
                                    >
                                        {Object.entries(states[0]).map((s, i) => {
                                            return <option key={i} value={s[0]}>{s[1]}</option>
                                        })}
                                    </Input>
                                </FormGroup>
                                <FormGroup>
